...
public class SMCChecker {
    ...
    // It should be an absolute addressing to the verifier
    // Becareful that the type of addressing can be a little bit different in Windows platforms (normally using double backslash).
    public static String command = Paths.get("./uppaal-verifyta", "verifyta -a %f -E %f -u %s").toString();
