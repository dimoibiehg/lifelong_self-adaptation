...
public class DeltaIoTSimulator {
    ...
    public static Simulator createSimulatorForDeltaIoT() {
        ...
        mote10.setActivationProbability(new Constant<>(0.20));
        mote13.setActivationProbability(new Constant<>(0.30));
        ...
        simul.getRunInfo().setGlobalInterference(new DoubleRange(1.0, 4.0));
        //simul.getRunInfo().setGlobalInterference(new DoubleRange(1.0, snr_middle_window + step));
        // simul.setMaxTimeSlots(maxQueueSlots);
        // cycle_counter += 1;
        // snr_middle_window = min_snr_val + Math.abs(Math.sin((cycle_counter*1.0)/max_snr_cycle * Math.PI / 2)) * (max_snr_val - min_snr_val);
